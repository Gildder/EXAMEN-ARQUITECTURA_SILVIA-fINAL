...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2016 a las 01:28:08
...
--
-- Base de datos: `consultorimedico`
--
...
INSERT INTO `paciente` (`idpaciente`, `nombre`, `fechanac`, `telefono`, `tiposangre`, `peso`) VALUES
(1, 'silvi lorena añez', '2010-12-10', 72532562, 'ORH+', 45),
(2, 'noris quintanilla', '1999-05-23', 74582369, 'A+', 52),
(3, 'wendy Callejas', '1994-07-15', 71258696, 'A+', 53);
